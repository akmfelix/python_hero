...
~~~
my_list = [5,7,5,7,3,323,21,6,98]
filt_list = [i for i in my_list if i>10]
print(filt_list)
# [323, 21, 98]

fil_gen = (i for i in my_list if i>10)
print(fil_gen)
# <generator object <genexpr> at 0x000001ABDCB522E0>
next(fil_gen)
# 323
~~~
